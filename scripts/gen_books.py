...
BOOKS = [
    dict(slug="coding-for-kids", title="Coding for Kids", cls="kids", btn="gold",
    ...
    dict(slug="coding-for-teens", title="Coding for Teens", cls="teens", btn="teal",
    ...
    dict(slug="build-a-bot", title="Build-A-Bot", cls="bot", btn="primary",
    ...
    dict(slug="teachers-edition", title="Teacher's Edition", cls="educators", btn="deep",
  ...
  <section class="downloads">
    <div class="wrap">
      <div class="sec-head center">
        <span class="eyebrow g">{series_title}</span>
